...
from init.api.permissions import IsActiveEmployee, HasAPIKey
...
class SupplyChainNodeViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsActiveEmployee, HasAPIKey]
    filter_backends = [SearchFilter]
    search_fields = ['address__country']

    def get_queryset(self):
        return SupplyChainNode.objects.filter(pk=self.request.supply_chain_node.pk)
